...
function idleAnimation() {
  ...
  boy.src = "resource/idle (" + idleImageNumber + ").png";
}
...
function runAnimation() {
  ...
  boy.src = "resource/run (" + runImageNumber + ").png";
}
...
function jumpAnimation() {
  ...
  boy.src = "resource/jump (" + jumpImageNumber + ").png";
}
...
function boyDeadAnimation(){
  ...
  boy.src = "resource/Dead ("+ deadImageNumber +").png";
}
